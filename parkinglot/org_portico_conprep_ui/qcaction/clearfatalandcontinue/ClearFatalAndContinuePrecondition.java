...
public class ClearFatalAndContinuePrecondition
    implements IActionPrecondition
{

    public ClearFatalAndContinuePrecondition()
    {
    }
    ...
    public boolean queryExecute(String s, IConfigElement iconfigelement, ArgumentList argumentlist, Context context, Component component)
    {
		...
		String roleName = "conprep_manager_role";
		if(HelperClass.performerCheck(component.getDfSession(),argumentlist.get("objectId"), addlnInfo) &&
		      HelperClass.roleCheck(component, argumentlist, context, roleName))
		{
			isValid = QcHelperClass.isValidClearFatalAndContinueProcessingAction(component.getDfSession(),
