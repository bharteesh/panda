 ...
 */
public class SchedulePrecondition implements IActionPrecondition {

	/**
	 *
	 */
	public SchedulePrecondition() {
	}
	...
	public boolean queryExecute(String action, IConfigElement iConfigElement, ArgumentList argumentlist, Context context, Component component)
	{
		...
		{
	        isValid = QcHelperClass.isValidScheduleAction(component.getDfSession(),
