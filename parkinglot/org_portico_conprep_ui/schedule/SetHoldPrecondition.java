 ...
 */
public class SetHoldPrecondition  implements IActionPrecondition {

	/**
	 *
	 */
	public SetHoldPrecondition() {
	}
	...
	public boolean queryExecute(String action, IConfigElement iConfigElement, ArgumentList argumentlist, Context context, Component component)
	{
	    ...
	    isValid = QcHelperClass.isValidSetHoldAction(component.getDfSession(),
