...
/**
 * Description	Precondition for unscheduling a batch
 * Author		pramaswamy
 * Type			UnSchedulePrecondition
 */
public class UnSchedulePrecondition implements IActionPrecondition {

	/**
	 *
	 */
	public UnSchedulePrecondition() {
	}
	...
	public boolean queryExecute(String action, IConfigElement iConfigElement, ArgumentList argumentlist, Context context, Component component)
	{
		...
		{
	        isValid = QcHelperClass.isValidUnScheduleAction(component.getDfSession(),
