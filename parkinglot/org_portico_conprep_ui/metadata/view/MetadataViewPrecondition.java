...
public class MetadataViewPrecondition
    implements IActionPrecondition
{

    public MetadataViewPrecondition()
    {
    }
    ...
    {
		// Note: MetadataView must have the same precondition as ProcessView
		return HelperClass.isValidProcessViewAction(component.getDfSession(),
