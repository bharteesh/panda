  ...
  CREATE TABLE "EJF_DESTINATIONS" 
   ...
   CREATE TABLE "TITLE_RUN_RECORDER" 
   (	
   	"RUN_ID" NUMBER NOT NULL ENABLE, 
	"TITLE_ID" NUMBER NOT NULL ENABLE, 
	"RUN_START_TIME" TIMESTAMP (6), 
	"RUN_END_TIME" TIMESTAMP (6), 
	"RUN_STATUS" VARCHAR2(20 BYTE) NOT NULL ENABLE, 
	"ERRORS" BLOB, 
	 CONSTRAINT "TITLE_RUN_RECORDER_PK" PRIMARY KEY ("RUN_ID"),
	 CONSTRAINT "TITLE_RUN_RECORDER_EJF_TI_FK1" FOREIGN KEY ("TITLE_ID") REFERENCES  "EJF_TITLES" ("TITLE_ID")
   );
   
  CREATE SEQUENCE  "TITLE_RUN_RECORDER_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE ; 

  CREATE INDEX TITLE_RUN_RECORDER_TITLE_ID ON TITLE_RUN_RECORDER(TITLE_ID);
